...
//             item.profile_image_url = `data:image/jpeg;base64,${decodedUrl}`;
//         }
//     });
...
//     this.employee_data.forEach(item => {
//         if (item.profile_image !== null) {
//             const hexEncodedImage = item.profile_image as string;

//             // Convert hex string to binary buffer
//             const imageBuffer = Buffer.from(hexEncodedImage, 'hex');
